...
void testHttpResponse() {
    struct http_response *hresp = http_get("http://api.xosoonline.me/ws/loto_recommend/calculate_weight", NULL);
    char * http_response = hresp->body;
    char * http_status_code = hresp->status_code;
